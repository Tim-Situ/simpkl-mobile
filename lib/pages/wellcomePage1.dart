  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        ...
        child: Center(
          child: Padding(
            padding: EdgeInsets.symmetric(horizontal: 30), // Padding untuk seluruh konten
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  padding: EdgeInsets.all(0), // Padding di sekitar teks
                  child: RichText(
                  ...
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                        ...
                        color: SimpklColor.darkBlue, // Warna hijau untuk latar belakang
                      ),
                      child: IconButton(
                        onPressed: () {
