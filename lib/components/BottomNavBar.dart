    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: List.generate(data.length, (i) => GestureDetector(
            onTap: () => onItemTapped(i),
            child: AnimatedContainer(
              duration: const Duration(milliseconds: 10),
              decoration: BoxDecoration(
                border: i == selectedIndex
                  ? const Border(top: BorderSide(width: 3.0, color: Colors.white,))
                  : null,
              ),
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(
                      data[i],
                      size: 25,
                      color: i == selectedIndex ? Colors.white : SimpklColor.softBlue,
                    ),
                    Text(
                      labels[i],
                      style: TextStyle(
